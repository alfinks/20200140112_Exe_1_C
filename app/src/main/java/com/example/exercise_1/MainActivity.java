        ...
        Signin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(nama) && TextUtils.isEmpty(password)){
                    ...
                    if (nama.equals("alfin") && password.equals("alfin1903")){
                        Toast t = Toast.makeText(getApplicationContext(), "Login Sukses", Toast.LENGTH_SHORT);
                        t.show();

                        Intent log = new Intent(getApplicationContext(), activity_3.class);
                        log.putExtras(b);
                        startActivity(log);
                    }
                    else if (nama.equals("alfin") && !password.equals("alfin1903")){
